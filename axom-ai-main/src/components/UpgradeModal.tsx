...
export function UpgradeModal({ isOpen, onClose }: UpgradeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-md p-8 overflow-hidden bg-black border border-white/20 rounded-3xl shadow-[0_0_40px_rgba(255,255,255,0.1)]">
        ...
        <div className="relative flex flex-col items-center text-center z-10">
          ...
          <Link 
            href="/profile"
            className="w-full py-3.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-semibold flex items-center justify-center gap-2 transition-all hover:scale-[1.02] shadow-lg mb-3"
          >
