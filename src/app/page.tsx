    ...
    <div className="min-h-screen bg-gradient-premium relative overflow-hidden flex flex-col items-center">
      ...
      <nav className="w-full max-w-7xl px-6 py-6 flex items-center justify-between z-10 glass-panel mt-4 rounded-2xl mx-4">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/signup" className="px-5 py-2.5 text-sm font-medium bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-all shadow-[0_0_15px_rgba(79,70,229,0.5)]">
            Start Learning
          </Link>
        </div>
      </nav>
      ...
      <main className="flex-1 w-full max-w-7xl px-6 flex flex-col items-center justify-center text-center z-10 mt-20 mb-32">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
            <Link href="/dashboard" className="px-8 py-4 text-base font-semibold bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(79,70,229,0.6)] hover:scale-105 active:scale-95">
              Start Learning Now
            </Link>
