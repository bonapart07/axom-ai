...
export default function ProfilePage() {
  ...
  const handleSaveProfile = async () => {
    ...
    if (success) {
      setProfile({ ...profile, name: editName, photoURL: editPhotoURL });
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left space-y-2">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-slate-400 text-sm">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col items-center">
                  <div className="text-3xl font-bold text-white mb-4">
                    ₹99<span className="text-lg text-slate-400 font-normal">/month</span>
                  </div>
                  <button 
                    onClick={handleUpgrade}
                    disabled={isProcessingPayment}
                    className="px-8 py-3 bg-gradient-to-r from-primary to-purple-600 text-white font-bold rounded-xl shadow-[0_0_30px_rgba(79,70,229,0.5)] hover:shadow-[0_0_40px_rgba(79,70,229,0.7)] transition-all hover:-translate-y-1 disabled:opacity-70 disabled:hover:translate-y-0"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 flex items-center gap-3">
                  ...
                  <button 
                    ...
                    disabled={isSaving}
                    className="flex-1 px-4 py-2 rounded-lg bg-primary hover:bg-primary/90 text-white transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                    {isSaving ? (
                      <>
